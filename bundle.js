...
/***/ function(module, exports, __webpack_require__) {
	...
	var generatePrimes = __webpack_require__(1);
	var getFactors = __webpack_require__(2);
	var table = __webpack_require__(3);
	var form = __webpack_require__(12);
	var $ = __webpack_require__(13);

	var formElement = $(form()).submit(displayTable);
	var formDiv = $('#form');
	formDiv.append(formElement);

	function displayTable(evt) {
	    var requestedNumber = Number($("#number").val());
	    var primes = generatePrimes(requestedNumber);
	    var factors = getFactors(primes);
	    $('#table').html($(table({ primes: primes, factors: factors })));
	    evt.preventDefault();
	    return false;
	}
...
/***/ function(module, exports) {
	...
	function getInitialSeries(max) {
	    return [{
	        number: 2,
	        marked: true
	    }].concat(range(max).slice(3).map(function (x) {
	        return {
	            number: x,
	            marked: false
	        };
	...
	function range(n) {
	    return Array.from(new Array(n)).map(function (x, i) {
	        return i;
	    });
	}
...
/***/ function(module, exports) {
	...
	module.exports = function (numbers) {
	    return numbers.map(function (n) {
	        return [n].concat(numbers.map(function (j) {
	            return n * j;
	        }));
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(depth0,helpers,partials,data) {
	  ...
	  return "<table>\n	<tr>\n		<th></th>\n"
	    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.primes : depth0),{"name":"each","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
	    + "	</tr>\n"
	    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.factors : depth0),{"name":"each","hash":{},"fn":this.program(3, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
	    + "</table>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
	    return "<form action=\"#\" id=\"number-of-primes\">\n	<input class=\"form-component\" type=\"number\" name=\"number\" id=\"number\" min=\"1\" />\n	<label class=\"form-component\" for=\"number\">Number of primes</label></br>\n	<button class=\"form-component\" type=\"submit\">Submit</button>\n</form>\n";
	},"useData":true});
